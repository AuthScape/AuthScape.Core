...
namespace Services.Database
{
    ...
    {
        /// <summary>
        /// Adds the DatabaseContext with auto-detected provider based on the connection string.
        /// </summary>
        ...
        {
            var provider = DetectProvider(appSettings.DatabaseContext);

            services.AddDbContext<DatabaseContext>(options =>
            {
                ConfigureProvider(options, provider, appSettings.DatabaseContext);
        ...
        /// <summary>
        /// Gets DbContextOptions for use with the DatabaseContext constructor.
