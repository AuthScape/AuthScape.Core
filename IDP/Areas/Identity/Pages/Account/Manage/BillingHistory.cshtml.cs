...
namespace IDP.Areas.Identity.Pages.Account.Manage
{
    ...
    public class BillingHistoryModel : PageModel
    {
        ...
        private readonly ILogger<BillingHistoryModel> _logger;

        public Guid ActiveWalletId { get; set; }
        public decimal Balance { get; set; }

        public BillingHistoryModel(DatabaseContext context, ILogger<BillingHistoryModel> logger)
        {
            _context = context;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                _logger.LogError(ex, "Error loading billing history page");
                Balance = 0;
                return Page();
            }
        }
