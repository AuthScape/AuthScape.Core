...
namespace AuthScape.TicketSystem.Controllers
{
    ...
    public class TicketController : ControllerBase
    {
        ...
        {
            var ticketId = await ticketService.CreateTicket(param.TicketTypeId, param.TicketStatusId, param.Description, param.Message, (PriorityLevel)param.PriorityLevel);
            return Ok(ticketId);
        }
